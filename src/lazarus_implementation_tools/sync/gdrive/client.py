...
class GoogleDriveClient:
    ...
    def download_file_wrapper(self, remote_path: str, local_path: Optional[str] = None) -> Any:
        ...
        Returns:
            Result dict with success status and content :param local_path:
    ...
    def upload_file(
        ...
        Returns:
            Dict containing file metadata including id, name, size, etc. :param
            destination_path:
    ...
    def create_folder_wrapper(self, folder_path: str, parent_path: str = "/") -> Any:
        ...
        Returns:
            Folder metadata dict :param parent_path:
    ...
    def search_files(self, query: str, folder_path: Optional[str] = None) -> Any:
        ...
        Returns:
            Search results :param folder_path:
    ...
    def create_sharing_link(
        ...
        Returns:
            Sharing link information :param link_type: :param scope:
